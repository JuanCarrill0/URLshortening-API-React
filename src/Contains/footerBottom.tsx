...
export const FooterBottom = () =>{
    return(
        <div className="bg-dark text-white grid grid-cols-6 text-sm pb-12 pt-7 gap-14">
            <h2 className="col-span-2 text-center mt-12 font-bold text-3xl">Shortly</h2>
            <div className="mt-12">
                <ul className="">
            ...
            <div className="grid grid-cols-4 mt-12 relative right-7 gap-2">
